...
$sql = "SELECT antrian.*, antrian.ID_ANTRIAN, antrian.STATUS, antrian.NOMOR_ANTRIAN, pasien.NAMA_PASIEN, pasien.TGL_LAHIR, pasien.JENIS_KELAMIN, pasien.ASURANSI, poli.NAMA_POLI
        FROM antrian
